...
public class EditHexagonDialog extends JDialog {
	...
	public EditHexagonDialog(HexagonAdapter h) {
		...
		Image img = new ImageIcon(AppFrame.class.getResource("/icons/hexagon.png")).getImage();
		this.setIconImage(img);

		outline = h.getOutlineColor();
		inside = h.getInsideColor();
		...
		btnSubmit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					...
					JOptionPane.showMessageDialog(EditHexagonDialog.this,
